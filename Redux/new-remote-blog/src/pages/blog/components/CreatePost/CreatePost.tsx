...
export default function CreatePost() {
   ...
   * - Vậy chúng ta sẽ dựa vào điều kiện có postId hoặc không có (tức đang trong chế độ edit hay không)
   * để show lỗi
   *
   * - Chúng ta cũng không cần thiết phải tạo một state errorForm
   * - Vì errorForm phụ thuộc vào `addPostResult`, `updatePostResult` và `postId` nên có thể dùng một
   * biến để tính toán
   */
  ...
  const errorForm: FormError = useMemo(() => {
     ...
     * mỗi kiểu lại có mỗi cấu trúc khác nhau nên chúng ta cần kiểm tra để hiển thị cho đúng
     */
